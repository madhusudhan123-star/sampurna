  ...
  const organs = [
    {
      ...
      name: 'Mouth & Esophagus',
      description:
        'Acidity can cause discomfort in the esophagus, leading to a burning sensation and sour taste.',
      position: {
        desktop: { top: '20%', left: '50%' },
        mobile: { top: '15%', left: '50%' },
      },
    ...
    },
    {
      ...
      name: 'Stomach',
      description:
        'Acidity primarily occurs here. Excess stomach acid can lead to heartburn, indigestion, and ulcers if untreated.',
      position: {
        desktop: { top: '42%', left: '52%' },
        mobile: { top: '35%', left: '52%' },
      },
    ...
    },
    {
      ...
      name: 'Small Intestine',
      description:
        'Acidity can slow digestion, affecting the absorption of nutrients in the small intestine.',
      position: {
        desktop: { top: '58%', left: '48%' },
        mobile: { top: '55%', left: '48%' },
      },
    ...
    },
    {
      ...
      name: 'Large Intestine',
      description:
        'While acidity originates in the stomach, it may also cause bloating and discomfort in the large intestine.',
      position: {
        desktop: { top: '72%', left: '50%' },
        mobile: { top: '70%', left: '50%' },
      },
  ...
  return (
    <div className="relative w-full rounded-b-[70px] z-10 pt-10 md:pt-20 bg-gradient-to-r from-[#988967] via-[#F7E9CC] to-[#AB9C7A]">
      <div className="w-full max-w-[1920px] mx-auto px-2 md:px-8">
        ...
        <p className="text-center text-gray-600 text-sm md:text-base max-w-2xl mx-auto mb-6 md:mb-12 px-4">
          {isMobile
            ? 'Tap on the affected parts to understand how acidity impacts your digestive system.'
            : 'Hover over different parts to explore how acidity affects your digestive system.'}
        </p>
